...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Portal', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '苍蓝的星球上我孤独一人。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://lycoris.love', // 网站地址
